...
const PrivacyPloicyPage = ({}) => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Mongolian Volleyball Association, CEO
            Office 901, 15-r khoroo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MVA - ALL Star, accessible from{" "}
            <a
              href="https://volleyball.ave.mn"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://volleyball.ave.mn
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mkhantamir@mesa.mn</li>
      </ul>
    </div>
  );
};

export default PrivacyPloicyPage;
